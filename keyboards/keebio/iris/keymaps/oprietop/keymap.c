...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DH] = LAYOUT (
    ...
    LCT(KC_MINS), LGT(KC_Z), TAT(KC_X), KC_C, KC_D,   KC_V,      KC_INS, KC_ENT,  KC_K,      KC_H,   KC_COMM, TAT(KC_DOT), RGT(KC_SLSH), RCT(KC_EQL),  \
                                              AD_ESC, S_TAB,     LO_SPC, RA_BSPC, S_DEL,     KC_RGUI \
  ),
  ...
  [_LO] = LAYOUT (
    ...
    KC_MUTE, KC_LCTL, KC_LSFT, KC_LGUI, KC_BTN1, KC_BTN2, M_RAN64, M_RAN64, KC_PGDN, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_MPLY, \
  ...
  [_AD] = LAYOUT (
     RESET,   M_WIPE,   KC_ACL0, KC_ACL1, KC_ACL2, KC_PSCR,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PSCR, \
     BL_STEP, BL_BRTG,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   UC_TABL, UC_FLIP, UC_RAGE, UC_NOOO, XXXXXXX, KC_NLCK, \
     DF(_QW), RGB_RMOD, RGB_HUI, RGB_SAI, RGB_VAI, KC_BRIU,                   UC_SCRE, UC_DISA, UC_WALL, UC_SOB,  XXXXXXX, KC_CAPS, \
     RGB_TOG, RGB_MOD,  RGB_HUD, RGB_SAD, RGB_VAD, KC_BRID, XXXXXXX, XXXXXXX, UC_SALU, UC_DANC, UC_SHRG, UC_DEAL, XXXXXXX, KC_SLCK, \
